...
// 232792560 is the smallest number that can be divided by each of the numbers from 1 to 20 
test("232792560 is the smallest number that can be divided by each of the numbers from 1 to 20", () => {
  expect(findSmallestMultiplierForNumRange(1,20)).toEqual(232792560);
});